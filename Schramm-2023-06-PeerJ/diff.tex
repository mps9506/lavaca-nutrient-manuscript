...
%DIF ADD C:/Data-Analysis-Projects/lavaca-nutrient-manuscript/Schramm-2023-06-PeerJ/Schramm-2023-08-PeerJ.tex   Mon Aug  7 11:58:59 2023
...
\multirow{-5}{*}{\raggedright\arraybackslash TCEQ-13383} & DO (mg/L) & 7.22 & 1.35 & 55 \DIFaddbeginFL & \DIFaddFL{ASTM D888-09(C) and TCEQ SOP V1 }&  & \DIFaddFL{5.00}\DIFaddendFL \\
\DIFdelbeginFL %DIFDELCMD < \cmidrule{1-5}
%DIFDELCMD <  %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-8}
...
\multirow{-5}{*}{\raggedright\arraybackslash TCEQ-13384} & DO (mg/L) & 7.51 & 1.32 & 54 \DIFaddbeginFL & \DIFaddFL{ASTM D888-09(C) and TCEQ SOP V1 }&  & \DIFaddFL{5.00}\DIFaddendFL \\
\DIFdelbeginFL %DIFDELCMD < \cmidrule{1-5}
%DIFDELCMD <  %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-8}
...
\multirow{-5}{*}{\raggedright\arraybackslash TCEQ-13563} & DO (mg/L) & 7.91 & 1.34 & 56 \DIFaddbeginFL & \DIFaddFL{ASTM D888-09(C) and TCEQ SOP V1 }&  & \DIFaddFL{5.00}\DIFaddendFL \\
\bottomrule
\end{tabular}
\DIFaddbeginFL \begin{tablenotes}
\item[\DIFaddFL{a}] \DIFaddFL{Ambient water reporting limit (AWRL) represents the highest concentration that can be used as a reporting limit by a laboratory for inclusion in the state's monitoring data.
