...
actions with downstream water quality [@schrammTotalMaximumDaily2022].  
Such methods could help identify and replicate effective water quality 
...
knitr::include_graphics("Schramm-2023-06-PeerJ_files/figure-latex/fig1.png")
...
```{r fig5, message=FALSE, warning=FALSE, fig.width=6.85, fig.asp=0.7, fig.cap="Fitted splines (shaded regions indicate 90\\% confidence intervals) from the temporal estuary GAM display the marginal smoothed effect of date on TP (A), NO\\textit{\\textsubscript{X}} (B), chlorophyll-\\textit{a} (C), TKN (D), and DO (E) concentrations at each site in Lavaca Bay.", dev='cairo_pdf'}
...
knitr::include_graphics("Schramm-2023-06-PeerJ_files/figure-latex/fig8.png")
