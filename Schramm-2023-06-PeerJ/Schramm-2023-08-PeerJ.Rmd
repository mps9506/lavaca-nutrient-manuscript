...
modelsummary::datasummary(`Station ID` * (`TP (mg/L)`+
  ...
  mutate(`Station ID` = case_when(
    `Station ID` == "TCEQ-13383" ~ "TCEQ-13383, Upper-Bay",
    `Station ID` == "TCEQ-13384" ~ "TCEQ-13384, Lower-Bay",
    `Station ID` == "TCEQ-13563" ~ "TCEQ-13563, Mid-Bay"),
...
dplyr::bind_rows(
  ...
  mutate(Parameter = case_when(
    ...
    Site = case_when(
      Site == "TCEQ-13563" ~ "Mid-Bay",
      Site == "TCEQ-13383" ~ "Upper-Bay",
  ...
  column_spec(column = 3,
              bold = c(F,F,F,F,F,F,F,F,T,T,F,T,T,F,T),
              italic = c(F,F,F,F,F,F,F,F,T,T,F,T,T,F,T)) |>
  column_spec(column = 4,
              bold = c(F,F,T,T,T,F,T,T,F,F,T,F,F,T,F),
              italic = c(F,F,T,T,T,F,T,T,F,F,T,F,F,T,F)) |>
  column_spec(column = 5,
              bold = c(T,T,F,F,F,T,F,F,F,F,F,F,F,F,F),
              italic = c(T,T,F,F,F,T,F,F,F,F,F,F,F,F,F)) |>
  collapse_rows(columns = 1, latex_hline = "major")
