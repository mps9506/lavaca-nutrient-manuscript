...
```{r fig6, message=FALSE, warning=FALSE, fig.width=6.85, fig.asp=0.7, fig.cap="Estimated effects of mean daily inflow residuals on mean TP, NO\\textsubscript{\\textit{x}}, chlorophyll-\\textit{a}, TKN, and DO concentrations in Lavaca Bay obtained from flow estuary GAMs."}
...
```{r fig7, message=FALSE, warning=FALSE, fig.width=6.85, fig.asp=0.45, fig.cap="Estimated effects of nutrient load residuals on TP and NO\\textsubscript{\\textit{x}} concentrations in Lavaca Bay obtained from flow+load estuary GAMs."}
