...
and 0.99 (Navidad River) fopr TP loads. Median PBIAS values were 2.00
...
Flow-normalized TP loads at both sites and flow-normalized NO~3~ loads at 
USGS-08164000 indicate watershed based loads did not change much over time
...
Lavaca River (USGS-08164000) are within the ranges in previous published studies
(Table \ref{tab:tpcomp}; [@dunnTrendsNutrientInflows1996; @rebich_sources_2011; @omaniEstimationSedimentNutrient2014; @wise_spatially_2019]). It isn't obvious
...
lower reaches of Lavaca Bay. @russell_effect_2006 also suggested the processing of 
