...
```{r}
#| label: tbl-table1
#| tbl-cap: "Summary of gauged streamflow and freshwater water quality samples between January 1, 2000 and December 31, 2020."
#| warning: false
...
#| label: tbl-table2
#| warning: false
#| tbl-cap: "Summary of estuary water quality samples collected between January 1, 2005 and December 31, 2020."
...
```{r}
#| label: tbl-table3
#| tbl-cap: "Set of GAM models specified for each water quality parameter response."
#| warning: false
df <- tibble(
...
#| message: false
#| warning: false
#| tbl-cap: "Estuary GAM AIC~c~ values and associated model probabilities (in parenthesis). Models with the highest probability for each site and water quality parameter combination are bolded and italicized for emphasis."
